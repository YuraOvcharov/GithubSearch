...
export class UsersServices {
    ...
    getCommits(username: string, reponame: string): Observable<any> {
        ...
        return this.http.get('https://api.github.com/repos/' + username + '/'+ reponame + '/commits'+'?client_id=2309e75b6e358fb6d758&client_secret=f8e374273c00f733bbb1ca2a2702ce8cc53f9e7d' )
        //return this.http.get('https://api.github.com/repos/facebook/react/commits?client_id=2309e75b6e358fb6d758&client_secret=f8e374273c00f733bbb1ca2a2702ce8cc53f9e7d' )
                        .pipe(map((response: Response) => response.json()));
    }
}